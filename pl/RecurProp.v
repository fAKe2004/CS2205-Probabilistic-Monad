...
Proof.
  intros t1.
  induction t1 as [ | l1 IHl1 v1 r1 IHr1]. (* Induction Hypo : for l1, r1, same_structure transitivity holds*)
  - (* Case t1 = Leaf *)
    intros t2 t3 H12 H23.
    destruct t2; simpl.
    -- unfold same_structure in H23. (* t2 Leaf*)
      exact H23.
    -- unfold same_structure in H12. (* t2 is Node, negative*)
      contradiction H12.
  - (* Case t1 = Node l1 r1 *)
    intros t2 t3.
    destruct t2 as [ | l2 v2 r2]; destruct t3 as [ | l3 v3 r3]; intros H12 H23.
    + (* t2 = Leaf and t3 = Leaf *)
      inversion H12.
    + (* t2 = Leaf and t3 = Node l3 r3 *)
      inversion H12.
    + (* t2 = Node l2 r2 and t3 = Leaf *)
      inversion H23.
    + (* t2 = Node l2 r2 and t3 = Node l3 r3 *)
      inversion H12. 
      inversion H23.
      constructor.
      * specialize (IHl1 l2 l3).
        apply IHl1; assumption.
      * specialize (IHr1 r2 r3).
        apply IHr1; assumption.
Qed.
(* Perhaps intros t1 t2. revert t1. would be easier.*)
