...
PL_FILE_NAMES = \
    Syntax.v SimpleProofsAndDefs.v InductiveType.v DenotationalBasic.v RecurProp.v BuiltInNat.v DenotationalRels.v Logic.v FixedPoint.v Monad.v List.v Monad2.v ProbMonad.v
	
PL_FILES=$(PL_FILE_NAMES:%.v=$(PL_DIR)/%.v)

# ASSIGNMENT_FILE_NAMES = \
# 	 Assignment1025b.v Assignment1029.v Assignment1108a.v Assignment1206a.v Assignment1206b.v
